...
// 스크립트의 위치가 body태그 위에 있는경우에 태그를 가져와서 사용해야 한다면
//   반드시 window가 load 한 다음에 태그 가져오기를 해야 한다.
...
window.onload=function(){
    ...
    const 필수입력 = document.getElementByClassName("essential");
